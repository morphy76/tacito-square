...
|---------|-------|-----------|------------|
| SPEC-FR-M8.1 | RBAC Role Model & Route Protection | keeper, shared | SPEC-FR-M3.5 |
| SPEC-FR-M8.2 | Usage Quotas (community + agent) | keeper | SPEC-FR-M3.2 |
...
| SPEC-FR-M8.5 | Audit Trail (events + queries) | keeper | SPEC-FR-M3.4 |
| SPEC-FR-M8.6 | Prompt Management (CRUD + versioning) | keeper | SPEC-FR-M3.4 |
| SPEC-FR-M8.7 | Skills Management (CRUD + MCP attach) | keeper | SPEC-FR-M3.4 |
