...
|---------|-------|--------|-----------|------------|
| SPEC-FR-M3-PG | PostgreSQL AgentStore (pgx, migrations) | FR-01.1 | keeper | SPEC-FR-01.1 |
| SPEC-FR-13.1 | RBAC role model enforcement | FR-13.1 | keeper, shared | SPEC-FR-08.5 |
| SPEC-FR-13.2 | Gin RBAC middleware (JWT → Keycloak JWKS) | FR-13.2 | shared | SPEC-FR-13.1 |
| SPEC-FR-13.3 | Principal logging (trace_id + subject + roles) | FR-13.3 | shared | SPEC-NFR-LOG |
| SPEC-FR-13.6 | Role-based route protection | FR-13.6 | keeper | SPEC-FR-13.2 |
