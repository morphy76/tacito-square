...
| SPEC-FR-M5.6 | Object Storage (S3/MinIO) | IN_PROGRESS | agent | [SPEC-FR-M5.6](functional/M5/SPEC-FR-M5.6.md) |
...
| BUG-M5.6 | Pod Memory Exhaustion and Message Pressure under Large Payload Processing | OPEN | HIGH | [BUG-M5.6](tasks/M5.BUG6/BUG-M5.6.md) |
