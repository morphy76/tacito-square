# SPEC-FR-M3.3: Agent-Community Assignment
...
| Milestone     | M3                                          |
| Component     | keeper                                      |
| Depends On    | SPEC-FR-M3.1, SPEC-FR-M3.2                 |
| Supersedes    | none                                        |
...
4. Assignment MUST trigger the creation of a TacitoAgent CRD (via SPEC-FR-M3.6).
