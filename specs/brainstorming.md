...
| 38 | **Implement Time-to-Live (TTL) and automatic closure for inactive threads**<br>Automatically close idle thread sessions after a configured TTL period to reclaim system memory and storage resources. | 🧠 Cognitive & Agents | **Already Addressed**<br>(Incorp. in draft `SPEC-FR-M10.4`) | **M10: Federation** | 4 ⭐ | 3 | **0** |
...
| 45 | **Save conversation history for recovery and Long-Term Memory**<br>Persist structured conversation history to support crash recovery and feed the Qdrant Long-Term Memory (LTM) pipeline. | 🧠 Cognitive & Agents | **Already Addressed**<br>(Incorp. in draft `SPEC-FR-M10.4`) | **M10: Federation** | 3 | 4 | **0** |
