...
func TestCommunityRepository_Lifecycle(t *testing.T) {
	...
	t.Run("Update Community", func(t *testing.T) {
		...
		comm.Status = domain.CommunityStatusActive
		...
		assert.Equal(t, domain.CommunityStatusActive, fetched.Status)
